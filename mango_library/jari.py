...
""" test """
asyncio.run(test_case(
    power_target=1.1*np.array([500, 520, 520, 520, 520, 520, 520, 520, 620, 720, 820, 3200, 4200, 5200, 8500, 12520, 8520, 4420, 2520, 1520, 520, 520, 520, 520, 80, 130, 220, 280, 470, 400, 440, 550, 570, 820, 900, 1010, 1230, 1520, 2400, 3000, 3400, 3800, 4200, 4600, 5000, 5400, 4800, 6000, 6100, 6200, 6300, 6400, 6400, 6400, 6500, 6600, 6600, 6500, 6500, 6500, 6400, 6100, 6100, 6200, 6100, 5800, 5600, 5100, 4200, 4600, 4700, 3300, 3300, 1860, 1270, 820, 540, 376, 220, 520, 520, 520, 520, 520, 520, 520, 520, 520, 520, 520, 520, 520, 520, 520, 520, 520]),
    heat_target=.1*np.array([300, 260, 260, 260, 260, 260, 260, 260, 310, 360, 410, 1600, 2100, 2600, 4250, 6260, 4260, 2210, 1260, 760, 260, 260, 260, 260, 40, 65, 110, 140, 235, 200, 220, 275, 285, 410, 450, 505, 615, 760, 1200, 1500, 1700, 1900, 2100, 2300, 2500, 2700, 2400, 3000, 3050, 3100, 3150, 3200, 3200, 3200, 3250, 3300, 3300, 3250, 3250, 3250, 3200, 3050, 3050, 3100, 3050, 2900, 2800, 2550, 2100, 2300, 2350, 1650, 1650, 930, 635, 410, 270, 188, 110, 260, 260, 260, 260, 260, 260, 260, 260, 260, 260, 260, 260, 260, 260, 260, 260, 260]),
    value_weights=[
        {'power_penalty': 2, 'heat_penalty': 2, 'power_kwh_price': 1, 'heat_kwh_price': 1, 'converted_price': .8, 'convert_amount': 1, 'gas_price': 0.07, 'max_gas_amount': 1000, 'gas_to_heat_factor': .5, 'gas_to_power_factor': .4, 'power_to_heat_factor': .9, 'power_to_heat_amount': 7},
        {'power_penalty': 2, 'heat_penalty': 2, 'power_kwh_price': 1, 'heat_kwh_price': 1, 'converted_price': .8, 'convert_amount': 1, 'gas_price': 0.07, 'max_gas_amount': 1000, 'gas_to_heat_factor': .5, 'gas_to_power_factor': .3, 'power_to_heat_factor': .9, 'power_to_heat_amount': 7},
        {'power_penalty': 2, 'heat_penalty': 2, 'power_kwh_price': 1, 'heat_kwh_price': 1, 'converted_price': .8, 'convert_amount': 1, 'gas_price': 0.07, 'max_gas_amount': 1000, 'gas_to_heat_factor': .4, 'gas_to_power_factor': .5, 'power_to_heat_factor': .9, 'power_to_heat_amount': 7},
        {'power_penalty': 2, 'heat_penalty': 2, 'power_kwh_price': 1, 'heat_kwh_price': 1, 'converted_price': .8, 'convert_amount': 1, 'gas_price': 0.07, 'max_gas_amount': 1000, 'gas_to_heat_factor': .3, 'gas_to_power_factor': .5, 'power_to_heat_factor': .9, 'power_to_heat_amount': 7},
        {'power_penalty': 2, 'heat_penalty': 2, 'power_kwh_price': 1, 'heat_kwh_price': 1, 'converted_price': .8, 'convert_amount': 1, 'gas_price': 0.17, 'max_gas_amount': 1000, 'gas_to_heat_factor': .5, 'gas_to_power_factor': .5, 'power_to_heat_factor': .9, 'power_to_heat_amount': 7},
    ],
    schedules_provider=[[[100, 104, 112, 111, 112, 107, 104, 110, 135, 157, 166, 688, 880, 1062, 1783, 2506, 1746, 901, 517, 309, 111, 107, 107, 107, 16, 28, 48, 60, 96, 84, 91, 112, 118, 165, 183, 219, 263, 310, 502, 601, 743, 807, 854, 975, 1044, 1135, 1020, 1314, 1331, 1295, 1344, 1354, 1312, 1295, 1396, 1370, 1380, 1388, 1346, 1359, 1299, 1322, 1323, 1316, 1251, 1263, 1149, 1065, 885, 997, 1021, 682, 714, 401, 260, 174, 117, 78, 48, 113, 110, 105, 113, 108, 106, 105, 111, 107, 112, 107, 114, 113, 113, 110, 112, 112],
                         [101, 104, 105, 112, 110, 112, 108, 113, 127, 155, 176, 669, 908, 1065, 1765, 2684, 1853, 961, 550, 325, 107, 106, 104, 112, 16, 28, 44, 60, 103, 81, 93, 118, 117, 174, 193, 204, 266, 326, 483, 622, 722, 826, 910, 938, 1071, 1120, 1005, 1266, 1244, 1318, 1359, 1378, 1330, 1338, 1340, 1394, 1371, 1389, 1377, 1309, 1360, 1326, 1239, 1348, 1328, 1189, 1180, 1120, 843, 956, 966, 703, 661, 400, 278, 166, 118, 78, 44, 109, 106, 111, 108, 106, 107, 112, 106, 105, 111, 111, 114, 113, 106, 111, 112, 106]],
