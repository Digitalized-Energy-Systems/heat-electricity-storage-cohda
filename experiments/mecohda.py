...
async def test_case(
    ...
    best_solution_candidate.dataframe_expanded().to_csv(f"{filename}_result_df.csv")
...
def case_hh(run_id):
    ...
    val = [
        ...
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 200)],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 200)],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 200)],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 200)],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 200)],
        [150, 999 * 0.11 / 430, 125, 951 / 430, 999 / 430, 0, 0, 0],
        [12, 0, 0, 0, 0, 0.9, 75, get_wind_schedule(36, 5, 3.7, 0.1, 0.03)],
        [12, 0, 0, 0, 0, 0.9, 75, get_wind_schedule(36, 5, 3.7, 0.1, 0.03)],
        [12, 0, 0, 0, 0, 0.9, 75, get_wind_schedule(36, 5, 3.7, 0.1, 0.03)],
        [12, 0, 0, 0, 0, 0.9, 75, get_wind_schedule(36, 5, 3.7, 0.1, 0.03)],
        [12, 0, 0, 0, 0, 0.9, 75, get_wind_schedule(36, 5, 3.7, 0.1, 0.03)],
...
def case_industry(run_id):
    ...
    # 'convert_amount', 'gas_price', 'max_gas_amount', 'gas_to_heat_factor', 'gas_to_power_factor', 'power_to_heat_factor', 'power_to_heat_amount'
    val = [
        [1500, 999 * 0.11 / 430, 1250, 951 / 430, 999 / 430, 0, 0, 0],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 800)],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 800)],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 800)],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 800)],
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 800)],
        [1500, 999 * 0.11 / 430, 1250, 951 / 430, 999 / 430, 0, 0, 0],
        [12, 0, 0, 0, 0, 0.9, 750, get_solar_schedule(5, 0.3, -800)],
        [12, 0, 0, 0, 0, 0.9, 750, get_solar_schedule(5, 0.3, -800)],
        [12, 0, 0, 0, 0, 0.9, 750, get_solar_schedule(5, 0.3, -800)],
        [12, 0, 0, 0, 0, 0.9, 750, get_solar_schedule(5, 0.3, -800)],
        [12, 0, 0, 0, 0, 0.9, 750, get_solar_schedule(5, 0.3, -800)],
        ...
        [12, 0, 0, 0, 0, 0, 0, get_solar_schedule(5, 0.3, 800)],
        [1500, 999 * 0.11 / 430, 1250, 951 / 430, 999 / 430, 0, 0, 0],
        [800, 999 * 0.11 / 430, 705, 951 / 430, 999 / 430, 0, 0, 0],
        [900, 999 * 0.11 / 430, 710, 951 / 430, 999 / 430, 0, 0, 0],
    ]
...
def case_storage_improvement(run_id):
    ...
    storages = [
        ["heat", 20, 20, 200, 0.9, 0.9, 0.5, 0.1],
        ["power", 20, 20, 200, 0.9, 0.9, 0.5, 0.1],
    ]
